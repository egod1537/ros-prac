...
bool mcl_msgs__msg__landmark__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mcl_msgs.msg._landmark.Landmark", full_classname_dest, 31) == 0);
  }
  mcl_msgs__msg__Landmark * ros_message = _ros_message;
  {  // id
...
PyObject * mcl_msgs__msg__landmark__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mcl_msgs.msg._landmark");
