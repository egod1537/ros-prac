...
#include "mcl_msgs/msg/detail/landmark__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mcl_msgs::msg::Landmark;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mcl_msgs::msg::Landmark *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mcl_msgs::msg::Landmark *>(
    untyped_ros_message);
...
{
  return &mcl_msgs::msg::typesupport_fastrtps_cpp::_Landmark__handle;
}
