...
#include "mcl_msgs/msg/detail/landmark_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mcl_msgs::msg::Landmark &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mcl_msgs::msg::Landmark &);
size_t get_serialized_size(
  const mcl_msgs::msg::Landmark &,
  size_t current_alignment);
size_t
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Landmark(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mcl_msgs
cdr_serialize(
  const mcl_msgs::msg::LandmarkArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mcl_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mcl_msgs::msg::LandmarkArray & ros_message)
{
  // Member: header
  ...
  // Member: landmarks
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mcl_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mcl_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mcl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mcl_msgs::msg::LandmarkArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: landmarks
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      mcl_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.landmarks[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mcl_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.landmarks[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mcl_msgs
max_serialized_size_key_LandmarkArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mcl_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mcl_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mcl_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mcl_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<mcl_msgs::msg::LandmarkArray>()
{
  return &mcl_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mcl_msgs, msg, LandmarkArray)() {
  return &mcl_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
