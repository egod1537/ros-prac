...
#include "mcl_msgs/msg/detail/landmark_array__rosidl_typesupport_fastrtps_c.h"
...
#include "mcl_msgs/msg/detail/landmark__functions.h"  // landmarks
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_mcl_msgs
...
using _LandmarkArray__ros_msg_type = mcl_msgs__msg__LandmarkArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: landmarks
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mcl_msgs__msg__Landmark(
        &array_ptr[i], cdr);
    }
  }
  ...
  mcl_msgs__msg__LandmarkArray * ros_message)
{
  ...
  // Field name: landmarks
  {
    ...
    if (ros_message->landmarks.data) {
      mcl_msgs__msg__Landmark__Sequence__fini(&ros_message->landmarks);
    }
    if (!mcl_msgs__msg__Landmark__Sequence__init(&ros_message->landmarks, size)) {
      fprintf(stderr, "failed to create array for field 'landmarks'");
      return false;
    }
    auto array_ptr = ros_message->landmarks.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mcl_msgs__msg__Landmark(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_mcl_msgs__msg__LandmarkArray(
  ...
  size_t current_alignment)
{
  const _LandmarkArray__ros_msg_type * ros_message = static_cast<const _LandmarkArray__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mcl_msgs__msg__Landmark(
  ...
  size_t current_alignment)
{
  ...
  // Field name: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mcl_msgs__msg__Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mcl_msgs__msg__LandmarkArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: landmarks
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mcl_msgs__msg__Landmark(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: landmarks
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mcl_msgs__msg__Landmark(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mcl_msgs__msg__Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mcl_msgs__msg__LandmarkArray * ros_message = static_cast<const mcl_msgs__msg__LandmarkArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mcl_msgs__msg__LandmarkArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mcl_msgs__msg__LandmarkArray * ros_message = static_cast<mcl_msgs__msg__LandmarkArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mcl_msgs__msg__LandmarkArray(cdr, ros_message);
}

static uint32_t _LandmarkArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mcl_msgs__msg__LandmarkArray(
...
static size_t _LandmarkArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mcl_msgs__msg__LandmarkArray(
...
static message_type_support_callbacks_t __callbacks_LandmarkArray = {
  "mcl_msgs::msg",
  "LandmarkArray",
...
static rosidl_message_type_support_t _LandmarkArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LandmarkArray,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mcl_msgs, msg, LandmarkArray)() {
  return &_LandmarkArray__type_support;
}
