...
{
  new (message_memory) msgs::msg::Temperature(_init);
}

void Temperature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs::msg::Temperature *>(message_memory);
  typed_message->~Temperature();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Temperature_message_member_array[2] = {
  {
    "value",  // name
    ...
    offsetof(msgs::msg::Temperature, value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::Temperature, unit),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::msgs::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs, msg, Temperature)() {
  return &::msgs::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
