...
bool p0_interfaces__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("p0_interfaces.msg._robot_status.RobotStatus", full_classname_dest, 43) == 0);
  }
  p0_interfaces__msg__RobotStatus * ros_message = _ros_message;
  {  // name
...
PyObject * p0_interfaces__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("p0_interfaces.msg._robot_status");
