...
#include "msgs/msg/detail/status__rosidl_typesupport_fastrtps_c.h"
...
using _Status__ros_msg_type = msgs__msg__Status;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
bool cdr_serialize_msgs__msg__Status(
  const msgs__msg__Status * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
bool cdr_deserialize_msgs__msg__Status(
  eprosima::fastcdr::Cdr & cdr,
  msgs__msg__Status * ros_message)
{
  // Field name: name
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
size_t get_serialized_size_msgs__msg__Status(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
size_t max_serialized_size_msgs__msg__Status(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs__msg__Status;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
bool cdr_serialize_key_msgs__msg__Status(
  const msgs__msg__Status * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
size_t get_serialized_size_key_msgs__msg__Status(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Status__ros_msg_type * ros_message = static_cast<const _Status__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
size_t max_serialized_size_key_msgs__msg__Status(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const msgs__msg__Status * ros_message = static_cast<const msgs__msg__Status *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_msgs__msg__Status(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  msgs__msg__Status * ros_message = static_cast<msgs__msg__Status *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_msgs__msg__Status(cdr, ros_message);
}

static uint32_t _Status__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs__msg__Status(
...
static size_t _Status__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs__msg__Status(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs, msg, Status)() {
