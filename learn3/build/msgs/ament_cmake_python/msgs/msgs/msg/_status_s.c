...
bool msgs__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._status.Status", full_classname_dest, 23) == 0);
  }
  msgs__msg__Status * ros_message = _ros_message;
  {  // name
...
PyObject * msgs__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._status");
